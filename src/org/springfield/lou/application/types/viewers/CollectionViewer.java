...
public class CollectionViewer extends ItemViewer implements ViewerInterface {
		
	private static String panels[] = { "Overview","Description","Native langauge","Copyright","Technical info","Noterik fields","Xml files"};
	private static CollectionViewer instance;
	
	public static CollectionViewer instance() {
		if (instance==null) instance = new CollectionViewer();
		return instance;
	}
